...
const Login = () => {
  ...
  const singup = async (e) => {
    ...
    try {
      ...
      const q = query(ref, where("values.email", "==", email));
      ...
      snap.forEach((doc) => {
        if (doc.data()?.values?.password === password) {
          localStorage.setItem("uid", doc.id);
          localStorage.setItem("user", JSON.stringify(doc.data()?.values));
        ...
        <div className="container">
          <div className="row justify-content-around ">
            ...
            <div className="col-md-6 col-12">
              <StyledWrapper>
                <form className="form w-100" action={"submit"}>
