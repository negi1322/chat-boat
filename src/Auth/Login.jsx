...
const Login = () => {
  ...
  const getData = async () => {
    try {
      ...
      const q = query(ref, where("values.gender", "==", true));
  ...
  return (
    <>
      <div className='login-container d-flex align-items-center' style={{ height: " 100vh" }}>
            ...
            <div className='col-md-6 col-12' >
              <StyledWrapper>
                <form className="form">
                  ...
                  <p className="p">Don't have an account? <span className="span" onClick={() => navigate("/")}>Sign Up</span>
